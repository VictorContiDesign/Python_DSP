...
def calc_StdDesviation(sigs_src_arr):
    ...
    # Std Desviation calculation
    _StdDesviation = _variance**(1/2)
    return _StdDesviation

result = calc_StdDesviation(sigs.InputSignal_1kHz_15kHz)
print(result)  